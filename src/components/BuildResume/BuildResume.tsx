...
const BuildResume = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen w-full overflow-hidden bg-gray-50">
        ...
        <form className="flex flex-col gap-6 max-w-2xl mx-auto">
          ...
          <div className="mb-4 bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300">
            ...
            <div className="flex flex-col space-y-3">
              ...
              <input
                ...
                className="w-full p-3 border rounded-lg font-sans text-gray-700 focus:ring-2 focus:ring-blue-200 focus:border-blue-500 transition-all duration-200"
              ...
              <input
                ...
                onChange={(e) =>
                  handleHeadlineChange("location", e.target.value)
                }
              />
              <label className="block text-gray-700 text-sm font-medium mb-1">
                Email
          ...
          <div className="mb-4 bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300">
            ...
            <textarea
              ...
              className="w-full p-3 border rounded-lg font-sans text-gray-700 focus:ring-2 focus:ring-blue-200 focus:border-blue-500 transition-all duration-200 min-h-[120px]"
          ...
          <div className="mb-4 bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300">
            ...
            {educationData.map((education, index) => (
              <div
                key={index}
                className="flex flex-col gap-3 mb-5 p-4 border rounded-lg bg-gray-50 hover:bg-gray-100 transition-all duration-300"
              >
                <label className="block text-gray-700 text-sm font-medium mb-1">
                  Degree
                </label>
                ...
                <button
                  type="button"
                  className="text-red-500 hover:text-red-700 text-sm mt-2 self-start transition-all duration-200 bg-red-50 hover:bg-red-100 px-4 py-2 rounded-lg flex items-center gap-2"
          ...
          <div className="mb-4 bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300">
            ...
            {skillsDate.map((skill, index) => (
              ...
              >
                ...
                <textarea
                  placeholder="Enter proficiencies..."
                  className="w-full p-3 border rounded-lg font-sans text-gray-700 focus:ring-2 focus:ring-blue-200 focus:border-blue-500 transition-all duration-200"
                  rows={3}
      ...
      <div className="lg:w-2/3 w-full bg-gray-100 p-4 md:p-8 lg:fixed lg:top-0 lg:right-0 lg:h-screen overflow-y-auto">
